...
var AboutDialog = function(editorUi)
{
        ...
        mxUtils.write(h3, mxResources.get('about') + ' Minimega');
        div.appendChild(h3);
        ...
        div.appendChild(img);*/
        mxUtils.br(div);
        mxUtils.write(div, `minimega is a tool for launching and managing virtual machines. It can run on your laptop or distributed 
        across a cluster. minimega is fast, easy to deploy, and can scale to run on massive clusters with virtually no setup.`);
        mxUtils.br(div);
        var link = document.createElement('a');
        link.setAttribute('href', 'http://www.minimega.org/');
        link.setAttribute('target', '_blank');
        mxUtils.write(link, 'minimega.org');
        ...
        function lookforvlan(cell){
                ...
                if (cell.getStyle().includes("switch")){
                        if (cell.getAttribute("vlan") == undefined ){
                                cell.setAttribute("vlan", searchNextVlan(vlanid).toString());
                        }
