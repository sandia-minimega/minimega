...
![SNL.png](scale_content/SNL.png){ width="600" }

![DOE.png](scale_content/DOE.png){ width="200" }

![NNSA.png](scale_content/NNSA.png){ width="200" }
...
minimega can run VMs with 2MB pages using the `optimize hugepages <path>` command, where `<path>` is the path to a mounted hugetlbfs.
...
![1k.png](scale_content/1k.png){ width="225" }

We also tried launching 1,000 VMs **per** **node** and found smooth scaling:

![Nk.png](scale_content/Nk.png){ width="225" }
...
![sc16.jpg](scale_content/sc16.jpg){ width="450" }
