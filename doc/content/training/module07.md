...
- TCP
    ...
    -  See [module 05](module05.md) on creating a tap to the host for one possible route for this.
...
```minimega title="cc01.mm"
--8<-- "training/module07_content/cc01.mm"
```

[Download this example](module07_content/cc01.mm){ download="cc01.mm" }

`cc clients` can be used to see more information about those clients:

```minimega title="cc02.mm"
--8<-- "training/module07_content/cc02.mm"
```

[Download this example](module07_content/cc02.mm){ download="cc02.mm" }
...
```minimega title="cc03.mm"
--8<-- "training/module07_content/cc03.mm"
```

[Download this example](module07_content/cc03.mm){ download="cc03.mm" }
...
```minimega title="cc04.mm"
--8<-- "training/module07_content/cc04.mm"
```

[Download this example](module07_content/cc04.mm){ download="cc04.mm" }
...
```minimega title="cc05.mm"
--8<-- "training/module07_content/cc05.mm"
```

[Download this example](module07_content/cc05.mm){ download="cc05.mm" }
...
```minimega title="cc06.mm"
--8<-- "training/module07_content/cc06.mm"
```

[Download this example](module07_content/cc06.mm){ download="cc06.mm" }
...
```minimega title="cc07.mm"
--8<-- "training/module07_content/cc07.mm"
```

[Download this example](module07_content/cc07.mm){ download="cc07.mm" }
...
```minimega title="cc08.mm"
--8<-- "training/module07_content/cc08.mm"
```

[Download this example](module07_content/cc08.mm){ download="cc08.mm" }
...
```minimega title="cc09.mm"
--8<-- "training/module07_content/cc09.mm"
```

[Download this example](module07_content/cc09.mm){ download="cc09.mm" }
...
```minimega title="cc10.mm"
--8<-- "training/module07_content/cc10.mm"
```

[Download this example](module07_content/cc10.mm){ download="cc10.mm" }
...
[Module 08: Background traffic](module08.md)
