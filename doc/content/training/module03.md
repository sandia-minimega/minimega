...
For a detailed explanation of Virtual Machine Types, see the
[Virtual Machine Types article](../articles/vmtypes.md).
...
```minimega title="disk.mm"
--8<-- "training/module03_content/disk.mm"
```

[Download this example](module03_content/disk.mm){ download="disk.mm" }
...
```minimega title="launch.mm"
--8<-- "training/module03_content/launch.mm"
```

[Download this example](module03_content/launch.mm){ download="launch.mm" }
...
```minimega title="launch_c.mm"
--8<-- "training/module03_content/launch_c.mm"
```

[Download this example](module03_content/launch_c.mm){ download="launch_c.mm" }

- A state of ERROR would mean something failed.

    -  use 'flush' to clear out VMs in the ERROR or QUIT states

```minimega title="flush.mm"
--8<-- "training/module03_content/flush.mm"
```

[Download this example](module03_content/flush.mm){ download="flush.mm" }
...
```minimega title="start.mm"
--8<-- "training/module03_content/start.mm"
```

[Download this example](module03_content/start.mm){ download="start.mm" }

- This puts the VM in the RUNNING state
- Use 'vm info' to confirm running state and other details:

```minimega title="vminfo.mm"
--8<-- "training/module03_content/vminfo.mm"
```

[Download this example](module03_content/vminfo.mm){ download="vminfo.mm" }

<a id="TOC_8."></a>

## Stopping VMs

```minimega title="mdk.mm"
--8<-- "training/module03_content/mdk.mm"
```

[Download this example](module03_content/mdk.mm){ download="mdk.mm" }

<a id="TOC_9."></a>

## VM States

![states.png](module03_content/states.png){ height="400" }
...
```minimega title="simple.mm"
--8<-- "training/module03_content/simple.mm"
```

[Download this example](module03_content/simple.mm){ download="simple.mm" }

<a id="TOC_15."></a>

## The Results in miniweb:

![simple_01.png](module03_content/simple_01.png){ height="550" }
...
[Module 04: Experiment Visualization](module04.md)
