...
[github](https://github.com/sandia-minimega/minimega/v2). This came both as a
...
minimega once again has a website at [minimega.org](http://minimega.org)
...
the repository, see [tip.minimega.org](http://tip.minimega.org).
...
See the [cc API](../reference/minimega.md) documentation for more
information.
...
[bridge API](../reference/minimega.md) for more information.
...
See the [deploy API](../reference/minimega.md) for more information.
...
See the [file API](../reference/minimega.md) for more information.
...
See the [vm migrate](../reference/minimega.md) and
[vm config migrate](../reference/minimega.md) API for more
information.
...
See the [screenshot API](../reference/minimega.md)
...
See the [vm tag API](../reference/minimega.md) for more information.
...
See the [cc API](../reference/minimega.md) for more information.
...
See the [vm cdrom API](../reference/minimega.md)
...
minimega is available as an x86-64 debian package, available [here](https://docs.google.com/uc?export=download&confirm=LWmy&id=0BzR9HKxE1M90MzNZWlJ3bEV4YUk). It is
...
[here](https://docs.google.com/uc?export=download&confirm=_0tL&id=0BzR9HKxE1M90N2ZJS2J4Q3Rxd2c). It should be sufficient to simply unpack the tarball and run tools
