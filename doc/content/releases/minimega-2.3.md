...
separate [article](../articles/namespaces.md). In short, namespaces allows
...
separate [article](../articles/router.md) describing its use and features.
...
[VNC article](../articles/vnc.md) for details.
...
[here](https://storage.googleapis.com/minimega-files/minimega-2.3.deb). It is
...
[here](https://storage.googleapis.com/minimega-files/minimega-2.3.tar.bz2).
