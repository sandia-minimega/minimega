...
[Go Playground](https://play.golang.org/p/m8TNTtygK0). Simply change the CIDR
...
- [Check bird status](http://bird.network.cz/?get_doc&v=20&f=bird-4.html) (if using minirouter)
```
