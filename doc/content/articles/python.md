...
`help(minimega)` or the [generated Python API reference](../reference/python.md)
for a full listing. Here's a simple example of a script to launch 10 VMs,
display their info, and then kill them:
