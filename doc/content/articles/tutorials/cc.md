...
control (cc) API, including executing commands, file I/O, and TCP tunnels. The
examples are static documentation; copy or enter them in a running minimega
instance to follow the tutorial.
...
[here](http://www.linux-kvm.org/page/WindowsGuestDrivers/Download_Drivers).
...
*in order* on the client. This means you can chain commands, such as "send a
...
--8<-- "articles/tutorials/cc/clients.mm"
```
...
--8<-- "articles/tutorials/cc/exec.mm"
```
...
```minimega title="exec2.mm"
--8<-- "articles/tutorials/cc/exec2.mm"
```

[Download this example](cc/exec2.mm){ download="exec2.mm" }
...
--8<-- "articles/tutorials/cc/process.mm"
```
...
--8<-- "articles/tutorials/cc/send.mm"
```
...
```minimega title="send2.mm"
--8<-- "articles/tutorials/cc/send2.mm"
```

[Download this example](cc/send2.mm){ download="send2.mm" }

After the client responds to the `cc exec` command, we can check the output.

```minimega title="send3.mm"
--8<-- "articles/tutorials/cc/send3.mm"
```

[Download this example](cc/send3.mm){ download="send3.mm" }
...
--8<-- "articles/tutorials/cc/recv.mm"
```
...
```minimega title="recv2.mm"
--8<-- "articles/tutorials/cc/recv2.mm"
```

[Download this example](cc/recv2.mm){ download="recv2.mm" }
...
```minimega title="recv3.mm"
--8<-- "articles/tutorials/cc/recv3.mm"
```

[Download this example](cc/recv3.mm){ download="recv3.mm" }

You can also print **all** responses by using the `all` keyword instead of a
command id:

```minimega title="recv4.mm"
--8<-- "articles/tutorials/cc/recv4.mm"
```

[Download this example](cc/recv4.mm){ download="recv4.mm" }
...
--8<-- "articles/tutorials/cc/prefix.mm"
```
...
```minimega title="prefix2.mm"
--8<-- "articles/tutorials/cc/prefix2.mm"
```

[Download this example](cc/prefix2.mm){ download="prefix2.mm" }
...
--8<-- "articles/tutorials/cc/filter.mm"
```
