...
type Property struct {
	...
	VLAN []VLAN `json:"vlans" yaml:"vlans"`
...
type Apps struct {
	Infrastructures []Infrastructure `json:"infrastructure" yaml:"infrastructure"`
	Experiments     []Experiment     `json:"experiment" yaml:"experiment"`
